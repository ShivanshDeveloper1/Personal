...
import SoacialEfforts from '@/components/(socialMedia)/SoacialEfforts';
    ...
    <main className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-300 max-w-7xl mx-auto px-6 lg:px-8 py-12 md:py-20 lg:py-24 overflow-hidden">
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10 lg:gap-16">
        ...
        >
          ...
          >
            Best <span className="text-blue-400 dark:text-blue-400">Social Media Marketing Agency</span> For Leads, Growth, &amp; Results
          </motion.h1>
          
          <motion.span 
            variants={textItemVariants}
            className="block mt-3 text-lg md:text-xl italic font-medium text-blue-400 dark:text-blue-400"
          >
          ...
          <motion.p 
            variants={textItemVariants}
            className="mt-6 text-base md:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-bold"
          >
            <span className="text-blue-400 font-semibold">
    Teachers, Business Owners & Entrepreneurs
  </span>{" "}
  are using social media to turn{" "}
  <span className="text-blue-400 font-semibold">
    lakhs into crores
  </span>. The only difference? They treat content as an investment—not an option.
          </motion.p>
          ...
          >
            ...
            <Link href={'/contact'} className="px-6 py-3 bg-blue-400 hover:bg-yellow-400 dark:bg-blue-400 dark:hover:bg-yellow-400 text-slate-900 font-semibold rounded-lg shadow-sm transition-colors block text-center" >
              Let's Grow Together
            </Link>
          </motion.div>
        </motion.div>
